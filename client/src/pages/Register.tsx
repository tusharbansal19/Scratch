...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Auto login after register? Or redirect to login. Let's redirect to login for simplicity.
            navigate('/login');
        } catch (err: any) {
        ...
        <div className="min-h-screen bg-[#1e1e1e] flex items-center justify-center p-4">
            <div className="bg-[#2a2a2a] border border-zinc-700 p-8 rounded-2xl w-full max-w-md shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-3xl font-bold text-white mb-2 text-center">Join Scratch</h2>
                    <p className="text-gray-400 text-center mb-8">Start creating infinite ideas today.</p>
